...
# demo UDP Request (before encrypted)
# +------+----------+----------+----------+
...
# demo UDP Response (before encrypted)
# +------+----------+----------+----------+
# | ATYP | DST.ADDR | DST.PORT |   DATA   |
# +------+----------+----------+----------+
# |  1   | Variable |    2     | Variable |
...
# demo UDP Request and Response (after encrypted)
# +-------+--------------+
# |   IV  |    PAYLOAD   |
# +-------+--------------+
# | Fixed |   Variable   |
...
#           request
# `local`   means local server of demo
# `remote`  means remote server of demo
...
from demo import cryptor, eventloop, lru_cache, common, shell
from demo.common import parse_header, pack_addr, onetimeauth_verify, \
...
class UDPRelay(object):
    ...
    def __init__(self, config, dns_resolver, is_local, stat_callback=None):
        ...
        self.tunnel_remote = config.get('tunnel_remote', "119.29.29.29")
    ...
    def _handle_server(self):
        ...
        if self._is_local:
            ...
            # spec https://demo.org/en/spec/one-time-auth.html
