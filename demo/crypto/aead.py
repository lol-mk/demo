...
from demo.crypto import util
from demo.crypto import hkdf
from demo.common import ord, chr
...
class AeadCryptoBase(object):
    """
    Handles basic aead process of demo protocol
