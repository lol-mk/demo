...
from demo import cryptor, eventloop, shell, common
from demo.common import parse_header, onetimeauth_verify, \
...
class TCPRelayHandler(object):
    ...
    def __init__(self, server, fd_to_handlers, loop, local_sock, config,
        ...
        # TCP Relay works as either dmlocal or dmserver
        # if is_local, this is dmlocal
    ...
    def _handle_stage_connecting(self, data):
        ...
        if self._config['fast_open'] and not self._fastopen_connected:
            # for dmlocal and fastopen, we basically wait for data and use
            # sendto to connect
            try:
                # only connect once
