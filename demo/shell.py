...
from demo.common import to_bytes, to_str, IPNetwork
from demo import cryptor
...
def get_config(is_local):
    ...
    config['pid-file'] = config.get('pid-file', '/var/run/demo.pid')
    config['log-file'] = config.get('log-file', '/var/log/demo.log')
...
Online help: <https://github.com/demo/demo>
''')


def print_server_help():
    print('''usage: dmserver [OPTION]...
A test demo.
